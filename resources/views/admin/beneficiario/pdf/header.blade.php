...
<p style="text-align: justify;"><b>El Ministerio de Urbanismo, Vivienda y Hábitat</b> certifica que el <b>Sr./Sra. {{ $bamper->PerNomPri }} {{ $bamper->PerNomSeg }} {{ $bamper->PerApePri }} {{ $bamper->PerApeSeg }} @if (empty($cas))
    {{ $bamper->PerApeCas }}
@else
 DE {{ $bamper->PerApeCas }}
